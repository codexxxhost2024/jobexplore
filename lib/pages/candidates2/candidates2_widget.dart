...
import 'candidates2_model.dart';
export 'candidates2_model.dart';

class Candidates2Widget extends StatefulWidget {
  const Candidates2Widget({super.key});

  @override
  State<Candidates2Widget> createState() => _Candidates2WidgetState();
}

class _Candidates2WidgetState extends State<Candidates2Widget> {
  late Candidates2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Candidates2Model());
